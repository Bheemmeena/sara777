(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('.time').click(function () {
            $('#timeProviderName').text($(this).data('name'));
            $('#timeOpenResult').text($(this).data('openbidresulttime'));
            $('#timeOpenLastBid').text($(this).data('openbidtime'));
            $('#timeCloseResult').text($(this).data('closebidresulttime'));
            $('#timeCloseLastBid').text($(this).data('closebidtime'));

            if (!$(this).data('openbidresulttime') || !$(this).data('openbidtime')) {
                $('#timeOpen').hide()
                $('#timeTh').hide()
                $('#timeOpenTh').hide()
                $('#timeCloseTh').hide()
